...
Nazwy kolumn: `xG_PGM` — nasze, `xG_PB` — Polonii z tego samego czasu, `xGD` — różnica. Stany: `leading` / `draw` / `trailing`.
...
| 27:43 | PB | Lucjan Zieliński | 0,035 | po wrzucie | prawa noga | 19 m | 3 | — (dobitka) |
| 36:18 | PB | Maciej Wolski | 0,093 | po wrzucie | głowa | 8 m | 2 | Zieliński |
| 45:37 | PGM | Radosław Majewski | 0,010 | po wznowieniu | lewa noga | 21 m | 2 | — (przechwyt) |
