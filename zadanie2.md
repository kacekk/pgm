...
**Jego liczby to jego drużyna, nie nasza.** Jeśli grał w czwórce, która rzadko przechodziła w trójkę, to miał krótszy odcinek do pokrycia i inne zadania przy stracie niż u nas, gdzie ma domykać piątkę. Niska liczba dośrodkowań mówi wtedy o systemie jego drużyny, a nie o tym, czy on to potrafi. Tego żadna metryka nie naprawi. Mogę tylko uczciwie powiedzieć, na ile jego dotychczasowa gra przypomina tą, której oczekujemy.

**20 meczów starcza na jedne rzeczy, na inne nie.** Podań i kontaktów z piłką ma po kilkadziesiąt na mecz, więc te liczby są wiarygodne. Ale dośrodkowań w pole karne czy obron 1v1 jest po kilka, przy 20 meczach różnica między nim a naszym zawodnikiem najczęściej mieści się w granicy błędu. Nie można pozwolić aby niewielka różnica zagrała dużą rolę, w kwestii finalnego transferu lub rezygnacji.
...
Jedną stronę: te 5–6 rzeczy, o które pytał, przy każdej gdzie zawodnik jest na tle ligi i na tle naszych zawodników, wyraźnie zaznaczone, których dwóch–trzech rzeczy dane nie rozstrzygają, i kilkadziesiąt klipów do obejrzenia. Do tego zdanie, czego bym potrzebował, żeby domknąć temat — zwykle danych o bieganiu i obejrzenia go pod kątem samego ustawiania się bez piłki.
